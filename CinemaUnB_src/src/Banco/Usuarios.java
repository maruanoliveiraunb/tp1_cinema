...
public class Usuarios {
	...
	public int get_contagem_admins() throws SQLException{
		...
		PreparedStatement stmt = BC.conecta.prepareStatement("select count(*) from usuarios where tipo='admin' and status='ativo'");
	...
	public boolean usuario_login(String usuario,String senha) throws SQLException{
		int res = 0;
		boolean resultado = false;
		
		PreparedStatement stmt = BC.conecta.prepareStatement("select count(*) from usuarios where usuario=? and pwd=sha(?) and status='ativo'");
		stmt.setString(1, usuario);
	...
	public String usuario_tipo(String usuario) throws SQLException{
		...
		PreparedStatement stmt = BC.conecta.prepareStatement("select tipo from usuarios where usuario=?");
		stmt.setString(1, usuario);
